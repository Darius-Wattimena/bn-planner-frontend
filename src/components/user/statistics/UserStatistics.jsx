...
const UserStatistics = ({userId, users, hasStatistics, setHasStatistics}) => {
  ...
  let barchartRequest = Api.fetchUserStatisticsByFilter(barcharFilter)
  let piechartRequest = Api.fetchUserStatisticsByFilter(piechartFilter)
  ...
  let barHasData = (payload !== undefined && payload.length > 0)
